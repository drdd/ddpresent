...
?>
    <div id="primary" class="content-area" align="center">
         ...
         <div class="front">
            ...
            <div class="raid-calendar" >
                ...
                <div class="day <?php echo $day; ?>">
                    ...
                    <span style="z-index: 1;    display: block;   padding-top: 25px;"><?php echo $sdate;?></span>
                </div>
                <?php
                }
                ?>
        ...
        <div class="back">
            <div class="raid-calendar-nav">
                <a href="#" onclick="jQuery('#flipper').flip('toggle');"><span> Назад к Календарю </span></a>
            </div>
            <div class="raid-info-ctn">
                <div class="raid-details">
                    ...
                    <div style="float: left;width: 100%"><span style="float: left" id="rrl"> Бай</span>   <span  style="float: right"> заявок на участие: <i id="rbids">50</i></span></div>
